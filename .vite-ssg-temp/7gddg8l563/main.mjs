...
const XmlElementContent = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-db034d0f"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isLoading.value) {
        ...
        _push(`<input type="file"></div><hr><h2 class="leadingText">${ssrInterpolate(unref(uiTexts).viewerHeading)}</h2><div>`);
