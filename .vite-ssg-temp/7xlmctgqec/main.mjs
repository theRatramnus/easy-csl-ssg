...
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-a6d8e2ae><div class="content" data-v-a6d8e2ae>${ssrInterpolate(_ctx.content)}</div></div>`);
}
...
const XmlElementContent = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-a6d8e2ae"]]);
