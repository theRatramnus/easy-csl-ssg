...
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-7cc3ef4d><div class="content" data-v-7cc3ef4d>${ssrInterpolate(_ctx.content)}</div></div>`);
}
...
const XmlElementContent = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-7cc3ef4d"]]);
